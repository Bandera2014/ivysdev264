...
class MainActivity : AppCompatActivity() {
    ...
    navView.setNavigationItemSelectedListener {
        when(it.itemId){
            R.id.sentId -> {
                Snackbar.make(findViewById(R.id.sentId),"Your Email has been sent sucessfully",Snackbar.LENGTH_LONG).show()
            }
            R.id.outboxId -> {
                Snackbar.make(findViewById(R.id.outboxId),"This is your OutBox folder",Snackbar.LENGTH_LONG).show()
            }
            R.id.spamId -> {
                Snackbar.make(findViewById(R.id.outboxId),"This is your Spam folder",Snackbar.LENGTH_LONG).show()
            }
            R.id.calendarId -> {
                Snackbar.make(findViewById(R.id.outboxId),"This is your Calendar",Snackbar.LENGTH_LONG).show()
            }
            R.id.contactsId -> {
