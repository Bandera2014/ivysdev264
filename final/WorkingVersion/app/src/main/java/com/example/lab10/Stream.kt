...
//            R.id.action_settings -> Toast.makeText(this,"Settings",Toast.LENGTH_SHORT).show()
            ...
            R.id.action_new -> startActivity(Intent(this,PostActivity::class.java))
        }
